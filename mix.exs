defmodule NervesSystemPine64Plus.MixProject do
  use Mix.Project

  @github_organization "my-org"
  @app :nerves_system_pine64_plus
  ...
  defp nerves_package do
    [
      ...
      env: [
        ...
        {"TARGET_OS", "linux"},
        {"TARGET_ABI", "gnu"},
        {"TARGET_GCC_FLAGS", "-mabi=lp64 -fstack-protector-strong -mcpu=cortex-a53 -fPIE -pie -Wl,-z,now -Wl,-z,relro"}
      ],
